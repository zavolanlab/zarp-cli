...
class TestSnakemakeExecutor:
    ...
    def test_invalid_run(self, tmpdir):
        ...
        snke = snakemake.SnakemakeExecutor(myrun)
        os.chdir(tmpdir)
        snke.set_command(snkfile="notASnakefile.smk")
        exp_list = [
            "snakemake",
            "--snakefile",
            "notASnakefile.smk",
    ...
    def test_set_run_list(self):
        ...
        snke.set_command(snkfile="Snakefile")
        assert snke.get_run_list() == [
            "snakemake",
            "--snakefile",
            "Snakefile",
    ...
    def test_working_dir(self, tmpdir):
        ...
        snke_no_wd.set_command("Snakefile")
        assert snke_no_wd.get_run_list() == [
            "snakemake",
            "--snakefile",
            "Snakefile",
            "--cores",
        ...
        os.chdir(tmpdir)
        snkfile = create_test_files()
        snke.set_command(snkfile=snkfile)
        snke.run()
        assert snke.get_success()
